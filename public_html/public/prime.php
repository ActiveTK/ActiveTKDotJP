<?php
  $title = "【素数一覧】10,000万以下の素数の一覧 | ActiveTK.jp";
  $dec = "1億以下・1000万以下・100万以下・10万以下の素数を掲載しています。";
  $root = "https://www.activetk.jp/";
  $url = "{$root}public/prime";
...
<html lang="ja" itemscope="" itemtype="http://schema.org/WebPage" dir="ltr">
  <head>
    ...
    <script type="text/javascript" nonce="<?=$nonce?>">window.onload=function(){_("copy").onclick=function(){atk.copy(_("savek").value),_("copyk").innerHTML="コピーしました！"};_("clear").onclick=function(){_("save").value=""};_("td").onsubmit=function(){_('savek').value=atk.decode(_('save').value);return false};}</script>
    <?=Get_Default()?>
  </head>
