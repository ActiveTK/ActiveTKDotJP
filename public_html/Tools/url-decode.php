<?php
  $title = "URLデコーダー - ActiveTK.CF";
  $dec = "URLデコーダーです。";
  $root = "https://www.activetk.cf/";
  $url = "{$root}tools/url-decode.php";
?>
<!DOCTYPE html>
<html lang="ja" itemscope="" itemtype="http://schema.org/WebPage" dir="ltr">
  <head>
    ...
    <script src="https://code.activetk.cf/ActiveTK.min.js" type="text/javascript" charset="UTF-8" nonce="<?=$nonce?>"></script>
    <script type="text/javascript" nonce="<?=$nonce?>">onload=function(){_("copy").onclick=function(){atk.copy(_("savek").value),_("copyk").innerHTML="コピーしました！"};_("clear").onclick=function(){_("save").value=""};_("td").onsubmit=function(){_('savek').value=atk.decode(_('save').value);return false};}</script>
  </head>
  <body style="background-color:#6495ed;color:#080808;overflow-x:hidden;overflow-y:visible;">
    ...
    <div align="center" id="home">
        <h2>URLデコード - ActiveTK.CF</h2>
        <form action="url-encode.php" method="POST" id="td">
