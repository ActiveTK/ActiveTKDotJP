...
<html lang="ja" itemscope="" itemtype="http://schema.org/WebPage" dir="ltr">
  <head>
    ...
    <?php } ?>
    <?php if ($issumaho) {
      ?><script src="https://www.activetk.jp/js/cotrld_76907q706306a0jpa6s9f7m39a8ba02ar6d5254je89ep9c4.js" nonce="<?=$nonce?>"></script><?php
        } else { 
      ?><script src="https://www.activetk.jp/js/cotrld.js" nonce="<?=$nonce?>"></script><?php
    } ?>
    <script defer src="https://rinu.cf/pv/index.php?token=activetkcftokutei&callback=cotrld" nonce="<?=$nonce?>"></script>
    <?=Get_Default()?>
