<?php
  $title = "文字列の小文字化 | ActiveTK.jp";
  $dec = "文字列を小文字にする事ができます。";
...
<html lang="ja" itemscope="" itemtype="http://schema.org/WebPage" dir="ltr">
  <head>
    ...
    <script type="text/javascript" nonce="<?=$nonce?>">window.onload=function(){_("copy").onclick=function(){atk.copy(_("savek").value),_("copyk").innerHTML="コピーしました！"};_("clear").onclick=function(){_("save").value=""};_("td").onsubmit=function(){_('savek').value=_('save').value.toLowerCase();return false};}</script>
    <?=Get_Default()?>
  </head>
