...
<html lang="ja" itemscope="" itemtype="http://schema.org/WebPage" dir="ltr">
  <head>
    ...
    <script type="text/javascript" nonce="<?=$nonce?>">window.onload=function(){_("copy").onclick=function(){atk.copy(_("savek").value),_("copyk").innerHTML="コピーしました！"};_("clear").onclick=function(){_("save").value=""};_("td").onsubmit=function(){_('savek').value=atob(_('save').value);return false};}</script>
    <?=Get_Default()?>
  </head>
  <body style="background-color:#6495ed;color:#080808;overflow-x:hidden;overflow-y:visible;">
    ...
    <div align="center" id="home">
        <h1>base64デコーダー | ActiveTK.jp</h1>
        <form action="" method="POST" id="td">
          <textarea rows="14" id="save" style="margin: 0px; height: 140px; width: 542px;"></textarea>
          <br>
          <input type="submit" style="height:60px;width:140px;" value="デコード">
          <input type="button" style="height:60px;width:140px;" value="クリア" id="clear">
