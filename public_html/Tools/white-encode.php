<?php
  $title = "White Encoeder | ActiveTK.jp";
  $dec = "A White Encoeder";
  $root = "https://www.activetk.jp/";
  $url = "{$root}tools/white-encoder";
?>
<!DOCTYPE html>
<html lang="ja" itemscope="" itemtype="http://schema.org/WebPage" dir="ltr">
  <head>
    ...
    <script type="text/javascript" nonce="<?=$nonce?>" src="/js/white-encoder.js?v=9"></script>
    <?=Get_Default()?>
  </head>
  <body style="background-color:#6495ed;color:#080808;overflow-x:hidden;overflow-y:visible;">
    ...
    <div align="center" id="home">
        <h1>White Encoeder | ActiveTK.jp</h1>
        <p>指定された文字列を「\n」「Tab」「Empty」の3種類のデータで表現します。</p>
        <p><a href="white-decode">&gt; デコーダーはこちらです</a></p>
        <form action="" method="POST" id="td">
          ...
          <br>
          <input type="button" value="コピー" id="copy" style="height:60px;width:140px;"> <input type="button" value="JavaScriptとしてコピー" id="copy2" style="height:60px;width:200px;"><span id="copyk"></span>
        </form>
    </div>
    <br>
    <hr size="1" color="#7fffd4">
