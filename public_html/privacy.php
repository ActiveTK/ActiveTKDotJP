  ...
  <body style="background-color:#e6e6fa;">
    ...
    <div align="center" class="mainobject" style="position:fixed;overflow:scroll;color:#000000;z-index:1;top:12%;left:0px;width:100%;height:88%;">
      ...
      <div align="left" style="width:70%;overflow-x:hidden;overflow-y:visible;">
        ...
        本サイトでは、Google社の広告サービス「AdSense」を利用しています。<br>
        これにより、Google社並びに第三者配信事業者がCookieを使用すると共に、アクセスした際の情報に基づいて広告を配信・本サイト上に表示されます。<br>
        これらのCookieは、Google社の<a href="https://adssettings.google.com/authenticated" target="_blank">広告設定ページ</a>から選択若しくは削除する事ができます。<br><br>

        <b>第四条 アクセス数カウンター</b><br>
        本サイトでは、アクセス数カウンターを設置しています。<br>
        これにより、アクセス数のカウントを目的としてユーザーのIPアドレス及びアクセス回数の情報がサーバーに保存されますが、これは個人の特定に利用されるものではありません。<br><br>

        <h3>第二章 プライバシーの保護</h3>

        <b>第五条 Cookieの不使用</b><br>
        本サービスは、第二条並びに第三条の規定によるCookieを省いた、一切のCookieを使用しません。<br><br>

        <b>第六条 サービスの提供に伴ってサーバーへアップロードされる情報の不保持</b><br>
        第一条に定めるサービスの提供に伴ってサーバーへアップロードされる情報は、処理及びユーザーへのサービスの提供が終了した時点で、サーバーから完全に消去します。<br><br>

        <h3>第三章 情報の削除</h3>

        <b>第七条 削除の申し立て</b><br>
        ユーザーは、管理者に対して、サーバーからアクセスログを省いた自らがアップロードした全てのデータの削除を申し立てる事ができるものとします。<br><br>

        <h3>第四章 ユーザーの意思に基づくデータの利用</h3>

        <b>第八条 報告データの利用</b><br>
        ユーザーが、自らの意思に基づいたバグの報告やエラーページの報告を行った場合には、当該データをサービスの改善に使用させていただきます。<br>
