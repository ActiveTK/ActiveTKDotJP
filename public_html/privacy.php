  ...
  <body style="background-color:#e6e6fa;">
    ...
    <div align="center" class="mainobject" style="position:fixed;overflow:scroll;color:#000000;z-index:1;top:12%;left:0px;width:100%;height:88%;">
      ...
      <div align="left" style="width:70%;overflow-x:hidden;overflow-y:visible;">
        ...
        サービスの提供に伴い、ユーザーが入力したテキストや選択したファイルをサーバーへアップロードして、処理を行う事がございます。<br>
        これらの情報は、処理並びにユーザーへのサービスの提供が終了した時点で、サーバーから消去する事をお約束します。<br><br>

        <b>第二条 Cookieの不使用</b><br>
        本サービスは、第三条並びに第四条の規定によるCookieを省いた、一切のCookieを使用しません。<br><br>

        <b>第三条 Google社のサービス「Google アナリティクス」</b><br>
