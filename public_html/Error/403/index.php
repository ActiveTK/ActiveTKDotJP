<?php
  ...
  /*!
   * HTTPステータスコード 403 を表示します。
   */

  if ($_SERVER["REQUEST_URI"] == "/xmlrpc.php")
  {
    include("/home/activetk/activetk.jp/public_html/xmlrpc.php");
    exit();
  }
  ...
  $title = "【403】Forbidden - アクセスが拒否されました。";
    ...
    <div style="position:fixed;left:0px;top:0px;width:100%;background-color:transparent;z-index:1;">
      ...
      <div align="center" style="width:95%;">
        ...
        <div align="center" style="width:70%;vertical-align:middle;text-align:center;">
          ...
          <b>このエラーは、管理者がアクセスを制限しているファイルにアクセスした場合などに発生します。</b><br><br>
